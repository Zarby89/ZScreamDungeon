...
{
    public static class ConstantsJP
    {
        ...
        public static int entrance_xscroll = 0x14D45; // 0x14AA9 //2bytes each room
        public static int entrance_yscroll = 0x14E4F; // 0x14BB3 //2bytes
        public static int entrance_xposition = 0x14F59; //0x14CBD 2bytes
        public static int entrance_yposition = 0x15063;// 0x14DC7 2bytes
        public static int entrance_cameraxposition = 0x1516D;// 0x14ED1 2bytes
        public static int entrance_camerayposition = 0x15277;// 0x14FDB 2bytes
        ...
        public static void Init_Jp(bool rando = false)
        {
            ...
            entrance_xposition = 0x14CBD;// 2bytes
            entrance_yposition = 0x14DC7;// 2bytes
            entrance_cameraxposition = 0x14ED1;// 2bytes
            entrance_camerayposition = 0x14FDB;// 2bytes
