namespace ZeldaFullEditor.Gui
{
	partial class AdvancedChestEditorForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Replacement ID if duplicate (FF for none)";
			// 
			// groupBox1
			// 
			...
			this.widthHexbox.Decimal = false;
			...
			this.valueHexbox.Decimal = false;
			...
			this.addressHexbox.Size = new System.Drawing.Size(64, 20);
			...
			this.messageHexbox.Decimal = false;
			...
			this.alternateHexbox.Decimal = false;
