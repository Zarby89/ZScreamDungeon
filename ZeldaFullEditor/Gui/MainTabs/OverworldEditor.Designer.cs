namespace ZeldaFullEditor.Gui
{
    partial class OverworldEditor
    {
        ...
        private void InitializeComponent()
        {
			...
			this.OWExitPropY = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWExitPropX = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWExitPropID = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			...
			this.OWEntrancePropY = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWEntrancePropX = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWEntrancePropID = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			...
			this.OWTransportPropY = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWTransportPropX = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWTransportPropID = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			...
			this.OWProperty_MessageID = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWProperty_SPRPalette = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWProperty_SPRGFX = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWProperty_BGPalette = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			this.OWProperty_BGGFX = new ZeldaFullEditor.View.GeneralControls.Hexbox();
			...
			this.owPropertyPanel.Location = new System.Drawing.Point(0, 0);
		...
		private View.GeneralControls.Hexbox OWProperty_SPRPalette;
		private View.GeneralControls.Hexbox OWProperty_SPRGFX;
		private View.GeneralControls.Hexbox OWProperty_BGPalette;
		private View.GeneralControls.Hexbox OWProperty_BGGFX;
		public View.GeneralControls.Hexbox OWProperty_MessageID;
		...
		private View.GeneralControls.Hexbox OWExitPropY;
		private View.GeneralControls.Hexbox OWExitPropX;
		private View.GeneralControls.Hexbox OWExitPropID;
		private System.Windows.Forms.Panel OWEntrancePanel;
		private System.Windows.Forms.Label OWEntranceDisabled;
		private View.GeneralControls.Hexbox OWEntrancePropY;
		private View.GeneralControls.Hexbox OWEntrancePropX;
		private View.GeneralControls.Hexbox OWEntrancePropID;
		...
		private View.GeneralControls.Hexbox OWTransportPropY;
		private View.GeneralControls.Hexbox OWTransportPropX;
		private View.GeneralControls.Hexbox OWTransportPropID;
