...
namespace ZeldaFullEditor.Gui.MainTabs
{
    partial class SpriteEditor
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DamageSubclassGroupBox = new System.Windows.Forms.GroupBox();
            ...
            this.bumpdamagemail3hexbox = new ZeldaFullEditor.Gui.ExtraForms.Hexbox();
            this.bumpdamagemail2hexbox = new ZeldaFullEditor.Gui.ExtraForms.Hexbox();
            this.bumpdamagemail1hexbox = new ZeldaFullEditor.Gui.ExtraForms.Hexbox();
            this.bumpDamagecombobox = new System.Windows.Forms.ComboBox();
            ...
            this.spriteListbox.Location = new System.Drawing.Point(3, 3);
            this.spriteListbox.Name = "spriteListbox";
            this.spriteListbox.Size = new System.Drawing.Size(192, 672);
            ...
            this.label17.Text = "01E800 - Location of compressed damage";
            ...
            this.label1.Text = "OAM allocation (-1)";
            this.toolTip1.SetToolTip(this.label1, "The number of objects (minus one) allocated to this sprite for drawing.");
            // 
            // label2
            // 
            ...
            this.groupBox1.MinimumSize = new System.Drawing.Size(0, 192);
            ...
            this.toolTip1.SetToolTip(this.nopermadeathindungeonsCheckbox, "Setting this flag prevents this sprite from being marked as dead in the underworl" +
        "d deaths array; i.e., it will always respawn when the room is reloaded.");
            ...
            this.immunearrowrumbleableCheckbox.Size = new System.Drawing.Size(96, 17);
            this.immunearrowrumbleableCheckbox.TabIndex = 64;
            this.immunearrowrumbleableCheckbox.Text = "Bonkable prize";
            this.toolTip1.SetToolTip(this.immunearrowrumbleableCheckbox, "This flag marks sprites that should be modified by bonking or quaking to become v" +
        "isible.");
            ...
            this.toolTip1.SetToolTip(this.immuneswordhammerCheckbox, "Setting this flag will make this sprite immune to melee attacks and recoil Link w" +
        "ith a tink when hit.");
            ...
            this.toolTip1.SetToolTip(this.projectilelikecollisionCheckbox, "Setting this flag will change the table used by this sprite for collision checks " +
        "to one that ignores certain tiles such as rails and pits.");
            ...
            this.toolTip1.SetToolTip(this.dieoffscreenCheckbox, "Setting this flag will cause the sprite to immediately die whenever it is too far" +
        " off the visible screen.");
            ...
            this.activeoffscreenCheckbox.Size = new System.Drawing.Size(137, 17);
            ...
            this.bossdamagesoundCheckbox.Size = new System.Drawing.Size(114, 17);
            this.bossdamagesoundCheckbox.TabIndex = 59;
            this.bossdamagesoundCheckbox.Text = "Alt. damage sound";
            this.toolTip1.SetToolTip(this.bossdamagesoundCheckbox, "Setting this flag will change the damage sound effect when this sprite is hit fro" +
        "m a \"punch\" to a \"slap\"");
            ...
            this.toolTip1.SetToolTip(this.blockedbyshieldCheckbox, "Setting this flag will cause this sprite to die if it collides with Link while fa" +
        "cing him, if he has a shield.");
            ...
            this.toolTip1.SetToolTip(this.checkforwaterCheckbox, "Used by very specific sprites to handle allowing movement on water tiles.");
            ...
            this.toolTip1.SetToolTip(this.invertpitbehaviorCheckbox, resources.GetString("invertpitbehaviorCheckbox.ToolTip"));
            ...
            this.dielikeabossCheckbox.Size = new System.Drawing.Size(77, 17);
            this.dielikeabossCheckbox.TabIndex = 55;
            this.dielikeabossCheckbox.Text = "Boss sprite";
            this.toolTip1.SetToolTip(this.dielikeabossCheckbox, "This flag marks sprites as bosses, causing them to explode on death and make the " +
        "boss grunt when hit.");
            ...
            this.overrideslashimmunityCheckbox.Size = new System.Drawing.Size(145, 17);
            this.overrideslashimmunityCheckbox.TabIndex = 54;
            this.overrideslashimmunityCheckbox.Text = "Override damage when 0";
            this.toolTip1.SetToolTip(this.overrideslashimmunityCheckbox, "When set, this flag will clear the sword cooldown timer and clear queued and appl" +
        "ied damage to this sprite when this sprite is hit for 0 damage from any damage c" +
        "lass except powder ($0A).");
            ...
            this.toolTip1.SetToolTip(this.deflectarrowsCheckbox, "Setting this flag will cause arrows that collide with this sprite to be deflected" +
        ".");
            ...
            this.persistoffscreenowCheckbox.Size = new System.Drawing.Size(106, 17);
        ...
        "screen. When not set, off-screen sprites will halt.");
            ...
            this.toolTip1.SetToolTip(this.ignoredbykillroomsCheckbox, "Setting this flag will cause kill room tags to ignore this sprite for their kill " +
        "tally.");
            ...
            this.toolTip1.SetToolTip(this.singlelayercollisionCheckbox, "Setting this flag will force this sprite to only check collision on its current l" +
        "ayer, irrespective of the current room\'s collision properties.");
            ...
            this.toolTip1.SetToolTip(this.graphicspageCheckbox, "Setting this flag will make draw routines default to the second nametable for thi" +
        "s sprite.");
            ...
            this.toolTip1.SetToolTip(this.drawshadowCheckbox, "Setting this flag will allow this sprite to have a shadow drawn for it if it call" +
        "s the conditional shadow draw routine.");
            ...
            this.toolTip1.SetToolTip(this.smallshadowCheckbox, "Setting thiss flag will make the default shadow draw routines use a small shadow." +
        "");
            ...
            this.toolTip1.SetToolTip(this.invulnerableCheckbox, "Setting this flag will make this sprite immune to all damage.");
            ...
            this.toolTip1.SetToolTip(this.customdeathanimationCheckbox, "Setting this flag will cause the death poof sprite mode to not draw the poof for " +
        "this sprite.");
            ...
            this.toolTip1.SetToolTip(this.allowedbossfightCheckbox, "Setting this flag will prevent this sprite from being deleted by bosses during ro" +
        "om load.");
            ...
            this.toolTip1.SetToolTip(this.immunepowderCheckbox, "Setting this flag will make this sprite completely immune to powder.");
            ...
            this.toolTip1.SetToolTip(this.beetargetCheckbox, "Setting this flag will make this sprite a high-priority target for player bees.");
            ...
            this.toolTip1.SetToolTip(this.recoilwithoutcollisionCheckbox, "Setting this flag will allow this sprite to ignore collision as it is being launc" +
        "hed back from recoil.");
            ...
            this.toolTip1.SetToolTip(this.harmlessCheckbox, "Setting this flag will prevent this sprite from damaging Link on collision.");
            ...
            this.damagetypeHexbox.MaxValue = 9;
            ...
            this.hitboxHexbox.Digits = ZeldaFullEditor.Gui.ExtraForms.Hexbox.HexDigits.Two;
            this.hitboxHexbox.HexValue = 0;
            this.hitboxHexbox.Location = new System.Drawing.Point(115, 64);
            this.hitboxHexbox.MaxLength = 2;
            this.hitboxHexbox.MaxValue = 31;
            ...
            this.oamslotHexbox.MaxValue = 31;
            ...
            // 
            // DamageSubclassGroupBox
            // 
            this.DamageSubclassGroupBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.DamageSubclassGroupBox.Controls.Add(this.damage0FHexBox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage0EHexBox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage0DHexBox);
            this.DamageSubclassGroupBox.Controls.Add(this.label25);
            this.DamageSubclassGroupBox.Controls.Add(this.label24);
            this.DamageSubclassGroupBox.Controls.Add(this.label23);
            this.DamageSubclassGroupBox.Controls.Add(this.damage0BHexBox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage0AHexBox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage09Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.label22);
            this.DamageSubclassGroupBox.Controls.Add(this.label21);
            this.DamageSubclassGroupBox.Controls.Add(this.label20);
            this.DamageSubclassGroupBox.Controls.Add(this.damage07Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.label19);
            this.DamageSubclassGroupBox.Controls.Add(this.damage06Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.label18);
            this.DamageSubclassGroupBox.Controls.Add(this.damage05Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.label16);
            this.DamageSubclassGroupBox.Controls.Add(this.label15);
            this.DamageSubclassGroupBox.Controls.Add(this.label14);
            this.DamageSubclassGroupBox.Controls.Add(this.damage0CHexBox);
            this.DamageSubclassGroupBox.Controls.Add(this.label13);
            this.DamageSubclassGroupBox.Controls.Add(this.damage08Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.label12);
            this.DamageSubclassGroupBox.Controls.Add(this.label11);
            this.DamageSubclassGroupBox.Controls.Add(this.damage04Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage03Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage02Hexbox);
            this.DamageSubclassGroupBox.Controls.Add(this.damage01Hexbox);
            ...
            this.DamageSubclassGroupBox.Location = new System.Drawing.Point(204, 207);
            this.DamageSubclassGroupBox.MinimumSize = new System.Drawing.Size(0, 120);
            ...
            this.damage0DHexBox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label25
            // 
            ...
            this.damage0AHexBox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // damage09Hexbox
            // 
            ...
            this.damage09Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label22
            // 
            ...
            this.damage07Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label19
            // 
            ...
            this.damage06Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label18
            // 
            ...
            this.damage05Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label16
            // 
            ...
            this.damage0CHexBox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label13
            // 
            ...
            this.damage08Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label12
            // 
            ...
            this.damage04Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // damage03Hexbox
            // 
            ...
            this.damage03Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // damage02Hexbox
            // 
            ...
            this.damage02Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // damage01Hexbox
            // 
            ...
            this.damage01Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // damage00Hexbox
            // 
            ...
            this.damage00Hexbox.TextChanged += new System.EventHandler(this.properties_TextChanged);
            // 
            // label10
            // 
            ...
            this.groupBox3.Location = new System.Drawing.Point(204, 333);
            this.groupBox3.MinimumSize = new System.Drawing.Size(0, 300);
            this.groupBox3.Name = "groupBox3";
            this.groupBox3.Size = new System.Drawing.Size(782, 300);
            this.groupBox3.TabIndex = 7;
            this.groupBox3.TabStop = false;
            this.groupBox3.Text = "Global damage class table (shared by all sprites)";
            // 
            // groupBox2
            // 
            ...
            this.groupBox2.Controls.Add(this.bumpdamagemail3hexbox);
            this.groupBox2.Controls.Add(this.bumpdamagemail2hexbox);
            this.groupBox2.Controls.Add(this.bumpdamagemail1hexbox);
            this.groupBox2.Controls.Add(this.bumpDamagecombobox);
            this.groupBox2.Location = new System.Drawing.Point(322, 19);
            this.groupBox2.MinimumSize = new System.Drawing.Size(0, 99);
            this.groupBox2.Name = "groupBox2";
            this.groupBox2.Size = new System.Drawing.Size(205, 99);
            this.groupBox2.TabIndex = 96;
            this.groupBox2.TabStop = false;
            this.groupBox2.Text = "Bump damage class groups";
            // 
            // label28
            // 
            ...
            this.label28.Text = "Armor3";
            // 
            // label27
            // 
            this.label27.AutoSize = true;
            this.label27.Location = new System.Drawing.Point(80, 57);
            this.label27.Name = "label27";
            this.label27.Size = new System.Drawing.Size(40, 13);
            this.label27.TabIndex = 100;
            this.label27.Text = "Armor2";
            // 
            // label26
            // 
            ...
            this.label26.Text = "Armor1";
            // 
            // bumpdamagemail3hexbox
            // 
            this.bumpdamagemail3hexbox.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            this.bumpdamagemail3hexbox.Decimal = false;
            this.bumpdamagemail3hexbox.Digits = ZeldaFullEditor.Gui.ExtraForms.Hexbox.HexDigits.Two;
            this.bumpdamagemail3hexbox.HexValue = 0;
            this.bumpdamagemail3hexbox.Location = new System.Drawing.Point(156, 73);
            this.bumpdamagemail3hexbox.MaxLength = 2;
            this.bumpdamagemail3hexbox.MaxValue = 255;
            this.bumpdamagemail3hexbox.MinValue = 0;
            this.bumpdamagemail3hexbox.Name = "bumpdamagemail3hexbox";
            this.bumpdamagemail3hexbox.Size = new System.Drawing.Size(36, 20);
            this.bumpdamagemail3hexbox.TabIndex = 98;
            this.bumpdamagemail3hexbox.Text = "00";
            this.bumpdamagemail3hexbox.TextChanged += new System.EventHandler(this.bumpdamagemail1hexbox_TextChanged);
            // 
            // bumpdamagemail2hexbox
            // 
            this.bumpdamagemail2hexbox.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            this.bumpdamagemail2hexbox.Decimal = false;
            this.bumpdamagemail2hexbox.Digits = ZeldaFullEditor.Gui.ExtraForms.Hexbox.HexDigits.Two;
            this.bumpdamagemail2hexbox.HexValue = 0;
            this.bumpdamagemail2hexbox.Location = new System.Drawing.Point(83, 73);
            this.bumpdamagemail2hexbox.MaxLength = 2;
            this.bumpdamagemail2hexbox.MaxValue = 255;
            this.bumpdamagemail2hexbox.MinValue = 0;
            this.bumpdamagemail2hexbox.Name = "bumpdamagemail2hexbox";
            this.bumpdamagemail2hexbox.Size = new System.Drawing.Size(36, 20);
            this.bumpdamagemail2hexbox.TabIndex = 97;
            this.bumpdamagemail2hexbox.Text = "00";
            this.bumpdamagemail2hexbox.TextChanged += new System.EventHandler(this.bumpdamagemail1hexbox_TextChanged);
            // 
            // bumpdamagemail1hexbox
            // 
            this.bumpdamagemail1hexbox.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            this.bumpdamagemail1hexbox.Decimal = false;
            this.bumpdamagemail1hexbox.Digits = ZeldaFullEditor.Gui.ExtraForms.Hexbox.HexDigits.Two;
            this.bumpdamagemail1hexbox.HexValue = 0;
            this.bumpdamagemail1hexbox.Location = new System.Drawing.Point(11, 73);
            this.bumpdamagemail1hexbox.MaxLength = 2;
            this.bumpdamagemail1hexbox.MaxValue = 255;
            this.bumpdamagemail1hexbox.MinValue = 0;
            this.bumpdamagemail1hexbox.Name = "bumpdamagemail1hexbox";
            this.bumpdamagemail1hexbox.Size = new System.Drawing.Size(36, 20);
            this.bumpdamagemail1hexbox.TabIndex = 96;
            this.bumpdamagemail1hexbox.Text = "00";
            this.bumpdamagemail1hexbox.TextChanged += new System.EventHandler(this.bumpdamagemail1hexbox_TextChanged);
            // 
            // bumpDamagecombobox
            // 
            this.bumpDamagecombobox.FormattingEnabled = true;
            this.bumpDamagecombobox.Items.AddRange(new object[] {
            "Group 00",
            "Group 01",
            "Group 02",
            "Group 03",
            ...
            "Group 08",
            "Group 09"});
            this.bumpDamagecombobox.Location = new System.Drawing.Point(6, 19);
            this.bumpDamagecombobox.Name = "bumpDamagecombobox";
            this.bumpDamagecombobox.Size = new System.Drawing.Size(193, 21);
            this.bumpDamagecombobox.TabIndex = 0;
            this.bumpDamagecombobox.SelectedIndexChanged += new System.EventHandler(this.bumpDamagecombobox_SelectedIndexChanged);
            // 
            // label8
            // 
            ...
            this.label8.Size = new System.Drawing.Size(446, 164);
            ...
            this.tabControl1.Size = new System.Drawing.Size(1003, 704);
            this.tabControl1.TabIndex = 8;
            // 
            // tabPage1
            // 
            this.tabPage1.Controls.Add(this.spriteListbox);
            this.tabPage1.Controls.Add(this.groupBox3);
            this.tabPage1.Controls.Add(this.groupBox1);
            this.tabPage1.Controls.Add(this.DamageSubclassGroupBox);
            this.tabPage1.Location = new System.Drawing.Point(4, 22);
            this.tabPage1.Name = "tabPage1";
            this.tabPage1.Padding = new System.Windows.Forms.Padding(3);
            this.tabPage1.Size = new System.Drawing.Size(995, 678);
            ...
            this.Size = new System.Drawing.Size(1003, 704);
            this.Load += new System.EventHandler(this.SpriteEditor_Load);
            this.groupBox1.ResumeLayout(false);
            this.groupBox1.PerformLayout();
            this.DamageSubclassGroupBox.ResumeLayout(false);
            this.DamageSubclassGroupBox.PerformLayout();
        ...
        private System.Windows.Forms.GroupBox DamageSubclassGroupBox;
        ...
        private System.Windows.Forms.ComboBox bumpDamagecombobox;
        private System.Windows.Forms.Label label28;
        private System.Windows.Forms.Label label27;
        private System.Windows.Forms.Label label26;
        private ExtraForms.Hexbox bumpdamagemail3hexbox;
        private ExtraForms.Hexbox bumpdamagemail2hexbox;
        private ExtraForms.Hexbox bumpdamagemail1hexbox;
