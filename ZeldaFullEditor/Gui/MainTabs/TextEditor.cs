...
namespace ZeldaFullEditor
{
    public partial class TextEditor : UserControl
    {
        ...
        public class TextElement
        {
            ...
            public Regex StrictPattern { get; }
            ...
            public TextElement(byte id, string token, bool arg, string description)
            {
                ...
                string pat = string.Format(arg ? "\\[{0}:?([0-9A-F]{{1,2}})\\]" : "\\[{0}\\]", Regex.Escape(Token)); // Need to escape to prevent bad with [...]
                Pattern = new Regex(pat, RegexOptions.Compiled);
                StrictPattern = new Regex($"^{pat}$", RegexOptions.Compiled);
            }
            ...
            {
                return StrictPattern.Match(dfrag);
            }
        }
        ...
        {
            return MessageData.NewLineTokens.Replace(str, "\r\n$0");
        }
        ...
        private void TextListbox_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            s = MessageData.NewLineTokens.Replace(msg, "\r\n");
