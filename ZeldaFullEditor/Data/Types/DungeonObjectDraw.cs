...
namespace ZeldaFullEditor.Data
{
	...
	public partial class RoomObjectType
	{
		...
		public static unsafe void DrawTiles(ZScreamer ZS, RoomObject obj, bool allbg, params DrawInfo[] instructions)
		{
			if (obj is RoomObjectPreview pre)
			{
				var alltilesData = (byte*) ZS.GFXManager.currentgfx16Ptr.ToPointer();
				byte* ptr = (byte*) ZS.GFXManager.previewObjectsPtr[pre.ObjectType.FullID].ToPointer();
		...
		private static void RoomDraw_ArbitraryDiagonalAcute_1to16(ZScreamer ZS, RoomObject obj, bool bothbg = false)
		{
		...
		private static void RoomDraw_ArbitraryYByX(ZScreamer ZS, RoomObject obj,
		...
		private static void RoomDraw_ArbitraryXByY(ZScreamer ZS, RoomObject obj,
			int sizex, int sizey, bool bothbg = false,
			int tilestart = 0, int xstart = 0, int ystart = 0)
		{
			DrawInfo[] list = new DrawInfo[sizex * sizey];
		...
		// Main routines
		//=======================================================================================================
		public static void RoomDraw_3x3FloorIn4x4SuperSquare(ZScreamer ZS, RoomObject obj)
		{
			int sizex = 24 * ((obj.Size >> 2) & 0x03);
			int sizey = 24 * ((obj.Size) & 0x03);
		...
		public static void RoomDraw_4x4BlocksIn4x4SuperSquare(ZScreamer ZS, RoomObject obj)
		{
			int sizex = 32 * ((obj.Size >> 2) & 0x03);
			int sizey = 32 * ((obj.Size) & 0x03);
		...
		public static void RoomDraw_4x4Corner_BothBG(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_4x4FloorOneIn4x4SuperSquare(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_Arbtrary4x4in4x4SuperSquares(ZS, obj);
		}

		public static void RoomDraw_4x4FloorTwoIn4x4SuperSquare(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_Arbtrary4x4in4x4SuperSquares(ZS, obj);
		}

		public static void RoomDraw_4x4Object(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_AgahnimsWindows(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 6, sizey: 4, xstart: 7, ystart: 4, tilestart: 0);
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 6, sizey: 4, xstart: 13, ystart: 4, tilestart: 0);
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 6, sizey: 4, xstart: 19, ystart: 4, tilestart: 0);
			...
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 6, sizey: 2, xstart: 12, ystart: 9, tilestart: 53);
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 6, sizey: 2, xstart: 18, ystart: 9, tilestart: 53);
			...
			//		{
			//			DrawTiles(ZS, obj, false, new DrawInfo(tid++, x + i, y));
			//		}
			//	}
			//}

			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 2, sizey: 6, xstart: 7, ystart: 14, tilestart: 65);
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 2, sizey: 6, xstart: 7, ystart: 20, tilestart: 65);
			...
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 5, sizey: 5, xstart: 7, ystart: 9, tilestart: 77);
			...
			//	{
			//		DrawTiles(ZS, obj, false, new DrawInfo(tid++, x, y));
			//	}
			//}
		}

		public static void RoomDraw_ArcheryGameTargetDoor(ZScreamer ZS, RoomObject obj)
		{
			int tid = 0;
		...
		public static void RoomDraw_AutoStairsMerged(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 4);
		}
		...
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 5);
		}

		public static void RoomDraw_BigGrayRock(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 2);
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 2, ystart: 2, tilestart: 8);
		}

		public static void RoomDraw_BigHole4x4_1to16(ZScreamer ZS, RoomObject obj)
		{
			...
			for (int x = 8; x < size; x += 8)
			{
				...
				{
					DrawTiles(ZS, obj, false, new DrawInfo(0, x, y));
				}
				DrawTiles(ZS, obj, false,
					new DrawInfo(10, x, 0),
		...
		public static void RoomDraw_BigLightBeamOnFloor(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 8, sizey: 4);
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 8, sizey: 4, ystart: 4, tilestart: 32);
		...
		public static void RoomDraw_BigWallDecor(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 8, sizey: 3);
		}

		public static void RoomDraw_BombableFloor(ZScreamer ZS, RoomObject obj)
		{
			// 00 04 02 06
			// 08 12 10 14
			// 01 05 03 07
		...
		public static void RoomDraw_CheckIfWallIsMoved(ZScreamer ZS, RoomObject obj)
		{
			// Nothing
		}

		public static void RoomDraw_ChestPlatformVerticalWall(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 2, sizey: 3);
		}

		public static void RoomDraw_ClosedChestPlatform(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DamFloodGate(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 10, sizey: 4);
		}

		public static void RoomDraw_DiagonalAcute_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryDiagonalAcute_1to16(ZS, obj, false);
		}

		public static void RoomDraw_DiagonalAcute_1to16_BothBG(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryDiagonalAcute_1to16(ZS, obj, true);
		}

		public static void RoomDraw_DiagonalCeilingBottomLeft(ZScreamer ZS, RoomObject obj)
		{
			...
			for (int s = 0; s < size; s += 8)
			{
				...
				{
					DrawTiles(ZS, obj, false, new DrawInfo(0, i, s));
				}
		...
		public static void RoomDraw_DiagonalCeilingBottomRight(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DiagonalCeilingTopLeft(ZScreamer ZS, RoomObject obj)
		{
			int length = 8 * (obj.Size + 4);
			int size = length;
		...
		public static void RoomDraw_DiagonalCeilingTopRight(ZScreamer ZS, RoomObject obj)
		{
			int size = 8 * (obj.Size + 4);
		...
		public static void RoomDraw_DiagonalGrave_1to16(ZScreamer ZS, RoomObject obj)
		{
			obj.Height = (obj.Size + 10) * 8;
			obj.Width = (obj.Size + 6) * 8;
			obj.DiagonalFix = true;
		...
		public static void RoomDraw_DoorSwitcherer(ZScreamer ZS, RoomObject obj)
		{
			// TODO ROOM DRAW
		}

		public static void RoomDraw_Downwards1x1Solid_1to16_plus3(ZScreamer ZS, RoomObject obj)
		{
			for (int s = 0; s < (obj.Size + 4) * 8; s += 8)
			{
				DrawTiles(ZS, obj, false, new DrawInfo(0, 0, s));
			}
		}

		public static void RoomDraw_Downwards2x2_1to15or32(ZScreamer ZS, RoomObject obj)
		{
			int size = obj.Size == 0 ? 32 : obj.Size;
			RoomDraw_DownwardsXbyY(ZS, obj, size, sizex: 2, sizey: 2);
		}

		public static void RoomDraw_Downwards2x2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2);
		}
		...
		public static void RoomDraw_DownwardsBigRail3x1_1to16plus5(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DownwardsBlock2x2spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2, spacing: 2);
		}

		public static void RoomDraw_DownwardsCannonHole3x4_1to16(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DownwardsDecor2x2spaced12_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2, spacing: 12);
		}

		public static void RoomDraw_DownwardsDecor3x4spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 3, sizey: 4, spacing: 2);
		}
		...
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 2, spacing: 4);
		}

		public static void RoomDraw_DownwardsDecor4x4spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 4, spacing: 2);
		}

		public static void RoomDraw_DownwardsDecor4x4spaced4_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 4, spacing: 4);
		}

		public static void RoomDraw_DownwardsEdge1x1_1to16(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DownwardsEdge1x1_1to16plus7(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DownwardsFloor4x4_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 4);
		}

		public static void RoomDraw_DownwardsHasEdge1x1_1to16_plus23(ZScreamer ZS, RoomObject obj)
		{
			for (int s = 8; s < ((obj.Size + 22) * 8); s += 8)
			{
				DrawTiles(ZS, obj, false, new DrawInfo(1, 0, s));
			}
		...
		public static void RoomDraw_DownwardsHasEdge1x1_1to16_plus3(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DownwardsLine1x1_1to16plus1(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DownwardsPillar2x4spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_DownwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 4, spacing: 2);
		}

		public static void RoomDraw_DownwardsWithCorners2x1_1to16_plus12(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_DrawRightwards3x6(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 6, sizey: 3);
		}

		public static void RoomDraw_DrenchingWaterFace(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 7);
		}

		public static void RoomDraw_EmptyWaterFace(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 3);
		}

		public static void RoomDraw_FloorLight(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 8, sizey: 4);
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 8, sizey: 4, ystart: 4, tilestart: 32);
			//int tid = 0;
		...
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 6, sizey: 4);
		}

		public static void RoomDraw_InterRoomFatStairs(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 4);
		}

		public static void RoomDraw_KholdstareShell(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 10, sizey: 8);
		}

		public static void RoomDraw_LampCones(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 4);
		}

		public static void RoomDraw_LightBeamOnFloor(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 4);
			...
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 4, ystart: 6, tilestart: 16);
		...
		public static void RoomDraw_MagicBatAltar(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 8, sizey: 7);
		}
		...
		public static void RoomDraw_Nothing(ZScreamer ZS, RoomObject obj)
		{
			// Nothing
		}

		public static void RoomDraw_Rightwards2x4spaced4_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 4, spacing: 4);
		}
		...
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 2);
		}
		...
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 4, sizex: 1, sizey: 1);
		}

		public static void RoomDraw_Rightwards1x2_1to16_plus2(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_Rightwards2x2_1to15or32(ZScreamer ZS, RoomObject obj)
		{
			int size = obj.Size == 0 ? 32 : obj.Size;

			RoomDraw_RightwardsXbyY(ZS, obj, size, sizex: 2, sizey: 2);
		}

		public static void RoomDraw_Rightwards2x2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2);
		}

		public static void RoomDraw_Rightwards2x4spaced4_1to16_BothBG(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 4, bothbg: true);
		}

		public static void RoomDraw_Rightwards2x4_1to15or26(ZScreamer ZS, RoomObject obj)
		{
			int size = obj.Size == 0 ? 26 : obj.Size;

			RoomDraw_RightwardsXbyY(ZS, obj, size, sizex: 2, sizey: 4);
		}

		public static void RoomDraw_Rightwards4x4_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 4);
		}
		...
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2, spacing: 2);
		}

		public static void RoomDraw_RightwardsCannonHole4x3_1to16(ZScreamer ZS, RoomObject obj)
		{
			int size = (obj.Size + 1) * 16;
		...
		public static void RoomDraw_RightwardsDecor2x2spaced12_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2, spacing: 12);
		}

		public static void RoomDraw_RightwardsDecor4x2spaced8_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 2, spacing: 8);
		}

		public static void RoomDraw_RightwardsDecor4x3spaced4_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 3, spacing: 4);
		}

		public static void RoomDraw_RightwardsDecor4x4spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 4, spacing: 2);
		}

		public static void RoomDraw_RightwardsDoubled2x2spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_RightwardsEdge1x1_1to16plus7(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 8, sizex: 1, sizey: 1);
		}

		public static void RoomDraw_RightwardsFakePots2x2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2);
		}

		public static void RoomDraw_RightwardsFloorTile4x2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 4, sizey: 2);
		}

		public static void RoomDraw_RightwardsHammerPegs2x2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 2);
		}

		public static void RoomDraw_RightwardsHasEdge1x1_1to16_plus2(ZScreamer ZS, RoomObject obj)
		{
			for (int s = 8; s <= ((obj.Size + 1) * 8); s += 8)
			{
				DrawTiles(ZS, obj, false, new DrawInfo(1, s, 0));
			}
		...
		public static void RoomDraw_RightwardsHasEdge1x1_1to16_plus23(ZScreamer ZS, RoomObject obj)
		{
			for (int s = 8; s < ((obj.Size + 22) * 8); s += 8)
			{
				DrawTiles(ZS, obj, false, new DrawInfo(1, s, 0));
		...
		public static void RoomDraw_RightwardsHasEdge1x1_1to16_plus3(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_RightwardsLine1x1_1to16plus1(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 1, sizey: 1);
		}

		public static void RoomDraw_RightwardsPillar2x4spaced4_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 4, spacing: 4);
		}

		public static void RoomDraw_RightwardsShelf4x4_1to16(ZScreamer ZS, RoomObject obj)
		{
			int size = (obj.Size + 1) * 16;
			...
			DrawTiles(ZS, obj, false,
				...
				new DrawInfo(12, size + 24, 0),
				new DrawInfo(13, size + 24, 8),
				new DrawInfo(14, size + 24, 16),
				new DrawInfo(15, size + 24, 24)
			);
		}

		public static void RoomDraw_RightwardsStatue2x3spaced2_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 3, spacing: 2);
		}

		public static void RoomDraw_RightwardsWithCorners1x2_1to16_plus13(ZScreamer ZS, RoomObject obj)
		{
			int size = (obj.Size + 12) * 8;
			for (int s = 8; s < size; s += 8)
			{
		...
		public static void RoomDraw_RupeeFloor(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_Single2x3Pillar(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 2, sizey: 3);
		}

		public static void RoomDraw_SmithyFurnace(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 6, sizey: 8);
		}

		public static void RoomDraw_SolidWallDecor3x4(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 3, sizey: 4);
		}

		public static void RoomDraw_SomariaLine(ZScreamer ZS, RoomObject obj)
		{
			DrawTiles(ZS, obj, false, new DrawInfo(0, 0, 0));
		}

		public static void RoomDraw_Spike2x2In4x4SuperSquare(ZScreamer ZS, RoomObject obj)
		{
		...
		public static void RoomDraw_SpiralStairs(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 3);
		}

		public static void RoomDraw_SpittingWaterFace(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 5);
		}

		public static void RoomDraw_StraightInterroomStairs(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 4);
		}

		public static void RoomDraw_TableBowl(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 2);
		}

		public static void RoomDraw_4x3OneLayer(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 4, sizey: 3);
		}
		...
		public static void RoomDraw_Utility3x5(ZScreamer ZS, RoomObject obj)
		{
			// TODO Zarby's routines seem wrong
		}

		public static void RoomDraw_Utility6x3(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 6, sizey: 3);
		}
		...
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 22, sizey: 11);
		}

		public static void RoomDraw_WaterHopStairs_A(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 2);
		}

		public static void RoomDraw_WaterHopStairs_B(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryYByX(ZS, obj, sizex: 4, sizey: 2, bothbg: true);
		}

		public static void RoomDraw_WaterOverlay8x8_1to16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_Arbtrary4x4in4x4SuperSquares(ZS, obj, sizebonus: 2);
		}

		public static void RoomDraw_Waterfall47(ZScreamer ZS, RoomObject obj)
		{
			// TODO ROOM DRAW
		}

		public static void RoomDraw_Waterfall48(ZScreamer ZS, RoomObject obj)
		{
			// TODO ROOM DRAW
		}

		public static void RoomDraw_Weird2x4_1_to_16(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_RightwardsXbyY(ZS, obj, obj.Size + 1, sizex: 2, sizey: 4);
		}

		public static void RoomDraw_WeirdCornerBottom_BothBG(ZScreamer ZS, RoomObject obj)
		{
			RoomDraw_ArbitraryXByY(ZS, obj, sizex: 3, sizey: 4, bothbg: true);
		}

		public static void RoomDraw_WeirdCornerTop_BothBG(ZScreamer ZS, RoomObject obj)
		{
