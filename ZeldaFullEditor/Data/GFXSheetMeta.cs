using static ZeldaFullEditor.SNESPixelFormat;
using static ZeldaFullEditor.SheetType;
...
namespace ZeldaFullEditor
{
	public class GFXSheetMeta
	{
		...
		public static readonly GFXSheetMeta MiscSheet = new(0xFF, None, SNESPixelFormat.SNES3BPP);
