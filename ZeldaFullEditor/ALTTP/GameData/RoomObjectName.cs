...
public record RoomObjectName(int ID, string Name) : EntityName(ID, Name)
{
	...
	public static readonly RoomObjectName[] ListOfSubtype1RoomObjects =
	{
		...
		new(0x051, "Cannon hole (bottom, north) ↔"),
		new(0x052, "Cannon hole (bottom, south) ↔"),
		new(0x053, "Pipe path ↔"),
		new(0x054, "Nothing"),
		...
		new(0x059, "Nothing"),
		new(0x05A, "Nothing"),
		new(0x05B, "Cannon hole (top, north) ↔"),
		new(0x05C, "Cannon hole (top, south) ↔"),
