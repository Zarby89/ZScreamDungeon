namespace ZeldaFullEditor
{
	public static class DefaultEntities
	{
		...
		{
			new(0x00, "Normal door"),
			new(0x02, "Normal door (lower layer)"),
			new(0x04, "Exit (lower layer)"),
			new(0x06, "Unused cave exit (lower layer)"),
			new(0x08, "Waterfall door"),
			new(0x0A, "Fancy dungeon exit"),
			new(0x0C, "Fancy dungeon exit (lower layer)"),
			new(0x0E, "Cave exit"),
			new(0x10, "Lit cave exit (lower layer)"),
			new(0x12, "Exit marker"),
			new(0x14, "Dungeon swap marker"),
			new(0x16, "Layer swap marker"),
			new(0x18, "Double sided shutter door"),
			new(0x1A, "Eye watch door"),
			new(0x1C, "Small key door"),
			new(0x1E, "Big key door"),
			new(0x20, "Small key stairs (upwards)"),
			new(0x22, "Small key stairs (downwards)"),
			new(0x24, "Small key stairs (lower layer; upwards)"),
			new(0x26, "Small key stairs (lower layer; downwards)"),
			new(0x28, "Dash wall"),
			new(0x2A, "Bombable cave exit"),
			new(0x2C, "Unopenable, double-sided big key door"),
			new(0x2E, "Bombable door"),
			new(0x30, "Exploding wall"),
			new(0x32, "Curtain door"),
			new(0x34, "Unusable bottom-sided shutter door"),
			new(0x36, "Bottom-sided shutter door"),
			new(0x38, "Top-sided shutter door"),
			new(0x3A, "Unusable normal door (lower layer)"),
			new(0x3C, "Unusable normal door (lower layer)"),
			new(0x3E, "Unusable normal door (lower layer)"),
			new(0x40, "Normal door (lower layer; used with one-sided shutters)"),
			new(0x42, "Unused double-sided shutter"),
			new(0x44, "Double-sided shutter (lower layer)"),
			new(0x46, "Explicit room door"),
			new(0x48, "Bottom-sided shutter door (lower layer)"),
			new(0x4A, "Top-sided shutter door (lower layer)"),
			new(0x4C, "Unusable normal door (lower layer)"),
			new(0x4E, "Unusable normal door (lower layer)"),
			new(0x50, "Unusable normal door (lower layer)"),
			new(0x52, "Unusable bombed-open door (lower layer)"),
			new(0x54, "Unusable glitchy door (lower layer)"),
			new(0x56, "Unusable glitchy door (lower layer)"),
			new(0x58, "Unusable normal door (lower layer)"),
			new(0x5A, "Unusable glitchy/stairs up (lower layer)"),
			new(0x5C, "Unusable glitchy/stairs up (lower layer)"),
			new(0x5E, "Unusable glitchy/stairs up (lower layer)"),
			new(0x60, "Unusable glitchy/stairs up (lower layer)"),
			new(0x62, "Unusable glitchy/stairs down (lower layer)"),
