...
namespace ZeldaFullEditor.OWSceneModes
{
	public class ExitMode
	{
		...
		public void SendExitData(ExitOW exit)
		{
			...
			buffer.Write(exit.UniqueID);
			buffer.Write(exit.ScrollModY);
			buffer.Write(exit.ScrollModX);
			buffer.Write(exit.DoorXEditor);
			buffer.Write(exit.DoorYEditor);
			buffer.Write(exit.AreaX);
			buffer.Write(exit.AreaY);
			...
			buffer.Write(exit.PlayerX);
			buffer.Write(exit.PlayerY);
