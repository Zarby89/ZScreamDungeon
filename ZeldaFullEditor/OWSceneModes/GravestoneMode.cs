...
namespace ZeldaFullEditor.OWSceneModes
{
	public class GravestoneMode
	{
		...
		private void SendGraveData(Gravestone gravestone)
		{
			...
			buffer.Write(gravestone.UniqueID);
			buffer.Write(gravestone.YTilePos);
			buffer.Write(gravestone.XTilePos);
			buffer.Write(gravestone.TilemapPos);
			buffer.Write(gravestone.GFX);
