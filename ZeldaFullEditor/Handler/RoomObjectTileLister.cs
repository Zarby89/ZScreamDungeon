	...
	public class RoomObjectTileLister
	{
		...
		public static RoomObjectTileLister CreateTileListingsFromROM(ZScreamer ZS)
		{
			...
			SetTilesFromMultipleAddresses(0x0CD,
				(ZS.Offsets.tile_address + ZS.ROM.Read16(ZS.Offsets.subtype1_tiles + 0xCD * 2), 24),
			...
			void AutoFindTiles(ushort id, int count)
			{
				...
				var pos = ZS.Offsets.tile_address + ZS.ROM.Read16(typebase + (byte) id * 2);
